...
class ApprovalManager:
    def __init__(self, approval_policy: ApprovalPolicy, cwd: Path, confirmation_callback: Callable[[ToolConfirmation], Awaitable[bool]] | None = None)->None:
    ...
    def _assess_command_safety(self, command: str)->ApprovalDecision:
        ...
        if is_dangerous_pattern(command):
